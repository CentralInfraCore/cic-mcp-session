#!/usr/bin/env python3
"""Claude Code `SessionStart` hook -> SANDBOXED session ingest outbox.

Job: session-ingest-hook-sandboxed-001. Thin entry-point: all logic lives in
hooks/_ingest_sandbox.py:run_hook(). Fires at session start; enqueues the event envelope.
...
COLLECTOR_NAME = "SessionStart.py"
